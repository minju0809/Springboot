...
function updateBoardMap(distance) {
  var boardMapInput = document.querySelector('input[name="board_map"]');
...
function placesSearchCB(data, status, pagination) {
  if (status === kakao.maps.services.Status.OK) {
      // 검색 결과를 표시하는 함수를 호출하여 지도에 표시합니다
      displayPlaces(data);
      // 페이지 번호를 표시하는 함수를 호출하여 페이지네이션을 업데이트합니다
