      ...
      <section>
        ...
        <div align=center>
          ...
          <div class="pokemon-container"
            style="text-align:center; display: grid; gap:4px; grid-template-columns: repeat(auto-fill, minmax(200px, auto));">
            <c:forEach items="${li}" var="pokemon">
              <div class="pokemon-card" style="border:1px solid black; margin: 2px; padding: 4px; border-radius: 12px;">
      ...
      <script>
        ...
        cards.forEach((card, index) => {
          ...
          card.addEventListener("mouseout", function (e) {
            ...
            card.style.transform = "perspective(350px) rotateX(0deg) rotateY(0deg)"
          })
        }
        )
